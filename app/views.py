...
def search(request):
    q=request.GET['q']
    data= Product.objects.filter(pro_name=q)
...
class ProductView(View):
    def get(self,request):
        ...
        otherit= Product.objects.filter(category='O')
        return render(request, 'app/home.html',{'mobiles':mobiles,'laptops':laptops,'televisions'
        :televisions,'otherit':otherit})
...
class ProfileView(View):
    ...
    def post(self,request):
        ...
        if form.is_valid():
            ...
            reg = Customer(user=usr,name=name,contact=contact,city=city,state=state,address=address,zipcode=zipcode)
            reg.save()
